	...
	<div id="wrapper">
		...
		<?php
			...
			if (isset($_POST['update'])) {
				...
				$sql_string = "UPDATE tblemployees SET lastname = :lastname, firstname = :firstname, sex = :sex, status = :status, departmentid = :departmentid ";
		...
		<form action="<?php echo $_SERVER['PHP_SELF'] . "?id=" . $id; ?>" method="post">
			...
			<fieldset>
				...
				<div>
					...
					<input type="radio" name="status" value="Single" <?php echo $result_retrieve['status'] === 'Single' ? ' checked' : '';?>> Single
					<input type="radio" name="status" value="Married" <?php echo $result_retrieve['status'] === 'Married' ? ' checked' : '';?>> Married
					<input type="radio" name="status" value="Separated" <?php echo $result_retrieve['status'] === 'Separated' ? ' checked' : '';?>> Separated
					<input type="radio" name="status" value="Widow/Widower" <?php echo $result_retrieve['status'] === 'Widow/Widower' ? ' checked' : '';?>> Widow/Widower
				</div>
				<div>
